  ...
  return (
    <div className="bg-black text-white min-h-screen py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-emerald-500">Terms and Conditions</h1>
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold text-emerald-500 mb-3">1. Product Nature</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-emerald-500 mb-3">2. No Refund Policy</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-emerald-500 mb-3">5. Payment Processing</h3>
