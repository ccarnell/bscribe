      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold text-yellow-400 mb-3">1. Information We Collect</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-yellow-400 mb-3">2. Use of Information</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div>
              <h3 className="text-xl font-bold text-yellow-400 mb-3">3. Sharing of Information</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div>
              <h3 className="text-xl font-bold text-yellow-400 mb-3">4. Security</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-yellow-400 mb-3">5. Cookies</h3>
